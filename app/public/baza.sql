DROP DATABASE IF EXISTS druzinaceri;
CREATE DATABASE IF NOT EXISTS druzinaceri;
USE druzinaceri;    

DROP USER IF EXISTS 'tristan'@'localhost';
DROP USER IF EXISTS 'readonly'@'localhost';

CREATE USER IF NOT EXISTS 'readonly'@'localhost' IDENTIFIED BY 'readonly';
GRANT SELECT ON *.* TO 'readonly'@'localhost';
CREATE USER 'tristan'@'localhost' IDENTIFIED BY 'tristan';

/*DROP USER 'tristan'@'localhost';*/

GRANT SELECT, INSERT, UPDATE, DELETE ON 62_berlak_tristan.* TO 'tristan'@'localhost';

CREATE TABLE narocniki (
    id_narocnik INT NOT NULL PRIMARY KEY AUTO_INCREMENT,
    ...
    naslov_podjetja VARCHAR(50),
    se_strinja TINYINT(1) NOT NULL,
    FOREIGN KEY(fk_posta) REFERENCES posta(id_posta)
);

INSERT INTO posta (kraj, st_posta) VALUES
    ('Adelešiči', 8341),
    ('Ajdovščina', 5270),
    ('Ankaran', 6281),
    ('Apače', 9253),
